      ...
      <div className="flex-1 w-full flex overflow-hidden min-h-0">
        ...
        <div className="w-[22%] bg-[#0b132b]/60 border-r border-blue-950/50 p-4 flex flex-col justify-between overflow-y-auto custom-scrollbar shrink-0 shadow-sm">
            ...
            <div className="space-y-3.5 text-[10px]">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder={`e.g. "Severe chest pain radiating to left arm, shortness of breath, sweating for 30 minutes"\n\nCtrl+Enter to submit`}
                  className="w-full bg-black/60 border border-blue-950/60 rounded p-2.5 text-white outline-none focus:border-cyan-500/40 text-xs resize-none leading-relaxed custom-scrollbar font-mono placeholder-slate-700"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 mt-4 shrink-0">
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl font-black uppercase tracking-widest text-[11px] transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer shadow-lg border ${
                isLoading
                  ...
                  : symptomsInput.trim()
                  ? 'bg-gradient-to-r from-cyan-900 to-blue-900 hover:from-cyan-800 hover:to-blue-800 border-cyan-500/50 text-white shadow-[0_0_20px_rgba(6,182,212,0.2)]'
            ...
            <button
              onClick={handleClear}
              className="w-full py-1.5 bg-slate-900/60 hover:bg-slate-800/60 border border-slate-800 rounded-lg text-slate-500 hover:text-slate-300 font-bold uppercase text-[9px] tracking-widest transition flex items-center justify-center gap-1.5 cursor-pointer"
            >
