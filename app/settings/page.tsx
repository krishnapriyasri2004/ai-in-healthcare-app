  ...
  return (
    <div className="w-full h-full p-8 flex flex-col gap-6 overflow-y-auto custom-scrollbar bg-[#020617] font-sans">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-black/50 border border-blue-950/60 p-5 rounded-xl flex flex-col gap-4">
          ...
          <div className="space-y-4 font-mono text-xs text-gray-300">
             ...
             <div className="flex items-center justify-between border-t border-blue-950/30 pt-3">
      ...
      <div className="bg-black/40 border border-blue-950/50 p-5 rounded-xl flex flex-col gap-4">
         ...
         <div className="grid grid-cols-4 gap-4 font-mono text-[10px] text-gray-400">
            <div className="p-3 bg-black/50 rounded border border-blue-950/30">
